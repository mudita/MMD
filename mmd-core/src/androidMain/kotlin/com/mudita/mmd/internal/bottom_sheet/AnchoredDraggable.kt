...
package com.mudita.mmd.internal.bottom_sheet
...
internal class AnchoredDraggableState<T>(
    ...
    suspend fun settle(velocity: Float) {
        ...
        if (confirmValueChange(targetValue)) {
            moveTo(targetValue, velocity)
        } else {
            // If the user vetoed the state change, rollback to the previous state.
            moveTo(previousValue, velocity)
        }
    }
 ...
 *   gesture interaction or another programmatic interaction like a [moveTo] or [snapTo] call.
 */
 ...
 *   gesture interaction or another programmatic interaction like a [moveTo] or [snapTo] call.
 */
internal suspend fun <T> AnchoredDraggableState<T>.moveTo(
    targetValue: T,
