...
fun TextFieldMMD(
    ...
    CompositionLocalProvider(LocalTextSelectionColors provides colors.textSelectionColors) {
        BasicTextField(
            value = value,
            modifier = modifier
                .defaultErrorSemantics(isError, context.getString(R.string.default_error_msg))
                .defaultMinSize(
                    minWidth = TextFieldDefaultsMMD.MinWidth,
                    minHeight = TextFieldDefaultsMMD.MinHeight,
                ),
 ...
 *         }
 *
 *     TextFieldMMD(value = text, onValueChange = { text = it }, label = { Text("Label") })
 * }
 * ```
 *
            ...
            if (supporting != null) {
                ...
                Box(
                    Modifier
                        ...
                        .wrapContentHeight()
                        .padding(TextFieldDefaultsMMD.supportingTextPadding()),
                ) {
                    supporting()
                }
            }
...
/**
 * Places the provided text field and placeholder in [TextFieldMMD] when there is no label. When there
...
/** A draw modifier that draws a bottom indicator line in [TextFieldMMD] */
