...
/**
 * Properties used to customize the behavior of a [ModalBottomSheetMMD].
 *
...
class ModalBottomSheetPropertiesMMD(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is ModalBottomSheetPropertiesMMD) return false
...
/** Default values for [ModalBottomSheetMMD] */
@Immutable
@ExperimentalMaterial3Api
object ModalBottomSheetDefaultsMMD {

    /** Properties used to customize the behavior of a [ModalBottomSheetMMD]. */
    val properties = ModalBottomSheetPropertiesMMD()
}
...
internal fun ModalBottomSheetDialog(
    ...
    properties: ModalBottomSheetPropertiesMMD,
...
private class ModalBottomSheetDialogWrapper(
    ...
    private var properties: ModalBottomSheetPropertiesMMD,
