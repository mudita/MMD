...
import androidx.compose.ui.unit.dp
import com.mudita.mmd.components.text_field.TextFieldDefaultsMMD.Container

/**
 * Contains the default values used by [TextFieldMMD].
 */
@Immutable
object TextFieldDefaultsMMD {
    /** Default shape for a [TextFieldMMD]. */
    val shape: Shape
        @Composable get() = ContainerShape

    /**
     * The default min height applied to a [TextFieldMMD]. Note that you can override it by applying
     * Modifier.heightIn directly on a text field.
     */
    val MinHeight = 56.dp

    /**
     * The default min width applied to a [TextFieldMMD]. Note that you can override it by applying
     * Modifier.widthIn directly on a text field.
     */
    val MinWidth = 280.dp

    /** The default thickness of the indicator line in [TextFieldMMD] in unfocused state. */
    val UnfocusedIndicatorThickness = 1.dp

    /** The default thickness of the indicator line in [TextFieldMMD] in focused state. */
    val FocusedIndicatorThickness = 2.dp

    /**
     * Composable that draws a default container for a [TextFieldMMD] with an indicator line at the
     * bottom. You can apply it to a [BasicTextField] using [DecorationBox] to create a custom text
     * field based on the styling of a Material filled text field. The [TextFieldMMD] component applies
     * it automatically.
     *
    ...
    fun Container(
        ...
        Box(
            modifier
                .textFieldBackground({ containerColor }, shape)
                .indicatorLine(
                    enabled = enabled,
                    isError = isError,
                    interactionSource = interactionSource,
    ...
    /**
     * A modifier to draw a default bottom indicator line for [TextFieldMMD]. You can apply it to a
     ...
     *
     * If your text field requires customising elements that aren't exposed by [TextFieldMMD], consider
    ...
    /**
     * Default content padding applied to [TextFieldMMD] when there is a label.
     *
     * The top padding represents ths distance between the top edge of the [TextFieldMMD] and the top
    ...
    /** Default content padding applied to [TextFieldMMD] when the label is null. */
    ...
    /**
     * Default padding applied to supporting text for both [TextFieldMMD] and [OutlinedTextField]. See
    ...
    private val defaultTextFieldColors: TextFieldColorsMMD
        @Composable get() = TextFieldColorsMMD(
            ...
            errorTextColor = ErrorInputColor,
            focusedContainerColor = ContainerColor,
            unfocusedContainerColor = ContainerColor,
            disabledContainerColor = ContainerColor,
            errorContainerColor = ContainerColor,
            cursorColor = CaretColor,
            errorCursorColor = ErrorFocusCaretColor,
            textSelectionColors = LocalTextSelectionColors.current,
            focusedIndicatorColor = FocusActiveIndicatorColor,
            unfocusedIndicatorColor = ActiveIndicatorColor,
            disabledIndicatorColor = DisabledActiveIndicatorColor
                .copy(alpha = DisabledActiveIndicatorOpacity),
            errorIndicatorColor = ErrorActiveIndicatorColor,
            focusedLeadingIconColor = FocusLeadingIconColor,
            unfocusedLeadingIconColor = LeadingIconColor,
            disabledLeadingIconColor = DisabledLeadingIconColor
                .copy(alpha = DisabledLeadingIconOpacity),
            errorLeadingIconColor = ErrorLeadingIconColor,
            focusedTrailingIconColor = FocusTrailingIconColor,
            unfocusedTrailingIconColor = TrailingIconColor,
            disabledTrailingIconColor = DisabledTrailingIconColor
                .copy(alpha = DisabledTrailingIconOpacity),
            errorTrailingIconColor = ErrorTrailingIconColor,
            focusedLabelColor = FocusLabelColor,
            unfocusedLabelColor = LabelColor,
            disabledLabelColor = DisabledLabelColor
                .copy(alpha = DisabledLabelOpacity),
            errorLabelColor = (ErrorLabelColor),
            focusedPlaceholderColor = InputPlaceholderColor,
            unfocusedPlaceholderColor = InputPlaceholderColor,
            disabledPlaceholderColor = DisabledInputColor
                .copy(alpha = DisabledInputOpacity),
            errorPlaceholderColor = InputPlaceholderColor,
            focusedSupportingTextColor = FocusSupportingColor,
            unfocusedSupportingTextColor = SupportingColor,
            ...
            focusedPrefixColor = InputPrefixColor,
            unfocusedPrefixColor = InputPrefixColor,
            disabledPrefixColor = InputPrefixColor
                .copy(alpha = DisabledInputOpacity),
            errorPrefixColor = InputPrefixColor,
            focusedSuffixColor = InputSuffixColor,
            unfocusedSuffixColor = InputSuffixColor,
            disabledSuffixColor = InputSuffixColor
                .copy(alpha = DisabledInputOpacity),
            errorSuffixColor = (InputSuffixColor),
        )
}
 ...
 * @param disabledSuffixColor the suffix color for this text field when disabled
 * @param errorSuffixColor the suffix color for this text field when in error state
 * @constructor create an instance with arbitrary colors. See [TextFieldDefaultsMMD.colors] for the
 *   default colors used in [TextFieldMMD]. See [OutlinedTextFieldDefaults.colors] for the default
...
val ContainerShape = RoundedCornerShape(4.0.dp)

private val ActiveIndicatorColor: Color
...
private val DisabledActiveIndicatorColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurface

private val DisabledInputColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurface
...
private val DisabledSupportingColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurface

private val DisabledTrailingIconColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurface

private val ErrorActiveIndicatorColor: Color
    @Composable get() = MaterialTheme.colorScheme.error

private val ErrorFocusCaretColor: Color
    @Composable get() = MaterialTheme.colorScheme.error

private val ErrorInputColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurface
...
private val ErrorSupportingColor: Color
    @Composable get() = MaterialTheme.colorScheme.error

private val ErrorTrailingIconColor: Color
    @Composable get() = MaterialTheme.colorScheme.error

private val FocusActiveIndicatorColor: Color
    @Composable get() = MaterialTheme.colorScheme.primary

private val FocusInputColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurface

private val FocusLabelColor: Color
    @Composable get() = MaterialTheme.colorScheme.primary

private val FocusLeadingIconColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

private val FocusSupportingColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

private val FocusTrailingIconColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

private val InputColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurface

private val InputPlaceholderColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

private val InputPrefixColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

private val InputSuffixColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant
...
private val SupportingColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

private val TrailingIconColor: Color
    @Composable get() = MaterialTheme.colorScheme.onSurfaceVariant

private const val DisabledActiveIndicatorOpacity = 0.25f
private const val DisabledInputOpacity = 0.25f
private const val DisabledLabelOpacity = 0.25f
private const val DisabledLeadingIconOpacity = 0.25f
private const val DisabledSupportingOpacity = 0.25f
private const val DisabledTrailingIconOpacity = 0.25f
