...
package com.mudita.mmd.components.divider
...
fun HorizontalDividerMMD(
    ...
    thickness: Dp = DividerDefaultsMMD.Thickness,
    color: Color = DividerDefaultsMMD.color,
) = HorizontalDivider(
    modifier = modifier,
    thickness = thickness,
    color = color,
